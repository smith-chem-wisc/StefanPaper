...
We amended the mansucript as follows:

> It has attractive properties similar to Morpheus, such as the ability of running large-scale search tasks on memory-restricted machines.