...
See Supplementary Table 1 for a complete listing.
...
We thank the members of the Smith lab for testing G-PTM-D and other MetaMorpheus functionality (Leah V. Schaffer, Anthony J. Cesnik, Rob Millikin, Lei Lu, Zach Rolfs, Sean Dai, Rachel Miller, Rachel Knoener), who contributed input to the improvement of mzLib, and MetaMorpheus. We thank the MetaMorpheus users outside of this lab who submitted useful comments on GitHub. This work was supported by the grant DBI-1458524 from the National Science Foundation.
