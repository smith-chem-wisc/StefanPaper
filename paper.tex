...
In Figure [fgr:fig1-calibErrors] these errors are plotted versus two important variables: the m/z value of the peak and the retention time.
It can be seen in the graphs of Figure ### that calibration successfully addresses errors in non-linearity as a function of both retention time and m/z.
...
The complete list of parameters analyzed in the calibration is provided as Table $$$ in the supplement. 
...
Calibration quality is further evaluated through the results of a standard 10ppm precursor tolerance database search.
...
One output of an MSFragger search is a list of PSMs with each entry containing the mass difference between the isolated precursor and the mass of the best matching theoretical peptide. MSFragger also doesn't automatically calibrate spectra prior to searching.
...
We have since increased the variety of PTMs added but including a number of new notches in the G-PTM-D first pass search.
