...
The described issues are apparent in mass difference histograms in Figure~\ref{fig:fig4mouse-1012}, generated by compiling the results of a 2.5 Da tolerance narrow-window search.
