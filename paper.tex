...
It is not novel, and many useful search tools such as Tandem, MSGF+, Coment, MSFragger, Sequest have this search functionality under names such as "isotope error option".
