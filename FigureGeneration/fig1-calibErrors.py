...
nice = pandas.read_csv(r"C:\Users\stepa\Data\PaperData\JurkatTrypsin\CalibrationTask\Task1-CalibratingAllJurkat\120426_Jurkat_highLC_Frac16init.ms1dptsv", sep='\t')

print("mean")
print(np.mean(nice['labelPPM']))
print("st dev")
print(np.std(nice['labelPPM']))
print("95% min")
print(np.mean(nice['labelPPM'])-2*np.std(nice['labelPPM']))
print("95% max")
print(np.mean(nice['labelPPM'])+2*np.std(nice['labelPPM']))


nice2 = pandas.read_csv(r"C:\Users\stepa\Data\PaperData\JurkatTrypsin\CalibrationTask\Task1-CalibratingAllJurkat\120426_Jurkat_highLC_Frac16round7inter-scan.ms1dptsv", sep='\t')

print("mean")
print(np.mean(nice2['labelPPM']))
print("st dev")
print(np.std(nice2['labelPPM']))
print("95% min")
print(np.mean(nice2['labelPPM'])-2*np.std(nice2['labelPPM']))
print("95% max")
print(np.mean(nice2['labelPPM'])+2*np.std(nice2['labelPPM']))
